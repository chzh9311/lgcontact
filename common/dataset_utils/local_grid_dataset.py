...
from common.msdf.utils.msdf import calc_local_grid
...
class LocalGridDataset(Dataset):
    ...
    def __init__(self, cfg, split):
        ...
        self.split = split
        mask_file = osp.join(cfg.preprocessed_dir, self.dataset_name, split, f'local_grid_masks_{self.grid_scale*1000:.1f}mm.npy')
