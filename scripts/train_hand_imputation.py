...
from common.model.hand_ipt_vae.hand_imputation import HandImputationVAE, HandImputationVAETrainer
...
@hydra.main(config_path="../config", config_name="hand_imp")
def main(cfg):
    print("Configuration:")
    ...
    model = HandImputationVAE(**cfg.hand_ae)
    ...
    if cfg.run_phase == 'train':
        pl_trainer = HandImputationVAETrainer(model, cfg)
        ...
        pl_trainer = HandImputationVAETrainer.load_from_checkpoint(cfg.ckpt_path, model=model, cfg=cfg)
